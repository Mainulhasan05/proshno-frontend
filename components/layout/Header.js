...
import { HiOutlineMenuAlt2, HiOutlineLogout, HiOutlineUser, HiOutlineBell } from 'react-icons/hi';
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-neutral-200">
      <div className="flex items-center justify-between h-14 lg:h-16 px-4 lg:px-6">
        {/* Left — hamburger (desktop sidebar trigger) + mobile branding */}
        <div className="flex items-center gap-3">
          ...
          <Link href={`/${user?.role || 'teacher'}`} className="flex items-center gap-2 lg:hidden">
            <div className="h-7 w-7 rounded-lg bg-gradient-to-br from-primary-600 to-primary-700 flex items-center justify-center">
              <span className="text-white font-bold text-[10px]">প্র</span>
            </div>
            <span className="text-sm font-bold text-neutral-800">প্রশ্নপিডিয়া</span>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="p-2 rounded-lg hover:bg-neutral-100 text-neutral-400 transition-colors relative">
          ...
          <div className="relative" ref={menuRef}>
            <button
              ...
              className="flex items-center gap-2.5 px-2 lg:px-3 py-1.5 rounded-lg hover:bg-neutral-100 transition-colors"
            >
              <div className="h-8 w-8 rounded-full bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center ring-2 ring-white shadow-sm">
